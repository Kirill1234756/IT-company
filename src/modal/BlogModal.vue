...
<template>
  <Teleport to="body">
    <div class="fixed inset-0 bg-black bg-opacity-50 z-50 overflow-y-auto">
      <div class="min-h-screen bg-blog-card">
        <!-- Close Button -->
            ...
            <div class="flex flex-col lg:flex-row gap-8">
              ...
              <div class="lg:w-1/3">
                <div class="bg-white rounded-2xl p-6 shadow-sm">
                  <h2 class="text-xl font-bold text-gray-900 mb-4 font-display">
                    {{ $props.post.fullTitle || $props.post.title }}
                  </h2>
...
<style scoped>
.prose {
  color: var(--blog-gradient-lower);
}

.prose h3 {
  color: var(--blog-gradient-darkest);
  font-weight: 700;
}
